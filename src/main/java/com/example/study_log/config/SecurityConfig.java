...
import com.example.study_log.exception.ExceptionHandlerFilter;
import com.example.study_log.service.JwtTokenService;
import com.example.study_log.service.UserService;
import com.example.study_log.utils.JwtFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(final HttpSecurity http) throws Exception {
        return http.cors(withDefaults())
                ...
                .addFilterBefore(new JwtFilter(jwtTokenService, userService, oauthConfig), UsernamePasswordAuthenticationFilter.class) // JWT Filter 추가
